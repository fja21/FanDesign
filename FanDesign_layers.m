classdef FanDesign_layers
    ...
    properties
        ...
        Vortex_bsi      % Control parameter b for each layer
    ...
    methods
        function obj = FanDesign_layers(inputArg1,inputArg2,inputArg3,inputArg4)
        ...
        function obj = volumetricchecktype1(obj)
            ...
            while obj.Vdot_dpre > obj.Vdot*1.01 || obj.Vdot_dpre < obj.Vdot*0.99
                ...
                if obj.Vdot_dpre < obj.Vdot
                    int_k = int_k+0.01;
                elseif obj.Vdot_dpre > obj.Vdot
                    int_k = int_k-0.01;
                end
            end
        ...
        function obj = volumetricchecktype1_iterate(obj,i)
            int_k = 0; %Set initial guess of integration constant k
            obj.Vdot_dpre = 0; % Set preliminary values of volumetric flow for iteration
            ...
            while obj.Vdot_dpre > obj.Vdot*1.01 || obj.Vdot_dpre < obj.Vdot*0.99
                ...
                A = obj.omega*obj.eta_h*obj.Vortex_a.*obj.r_bsi;
                B = (obj.Vortex_a.^2).*(log(obj.r_bsi));
                C = (obj.Vortex_a.*obj.Vortex_bsi(i))./obj.r_bsi;

                % Calculate Cm2 using Eq 3.41
                Vel_c_m2temp = sqrt( 2.*(A - B + C) + int_k);

                obj.Vel_c_m2(i) = Vel_c_m2temp(i);
        ...
        function obj = velocitytriangletype1(obj)
        ...
        function obj = bladecorrectiontype1(obj)
        ...
        function obj = loadingtype1(obj)
            ...
            obj.dP_tspre = 0;
            obj.Vortex_bsi = ones(1,10)*obj.Vortex_b; % Write vortex constant to each layer

            %% Run through with preliminary constants.
            obj = volumetricchecktype1(obj);
            obj.Vel_c_u2 = (obj.Vortex_a.*obj.r_bsi + obj.Vortex_b)./obj.r_bsi;
            obj.dP_ttd = obj.omega.*obj.r_bsi.*obj.Vel_c_u2.*obj.eta_h.*obj.rho;

            %% Blade Skew Correction useing (Eq 4.17)
            obj = bladecorrectiontype1(obj);

            %% Velocity Triangles - Checked MPB 05/06/2024
            obj = velocitytriangletype1(obj);

            %% Begin Layer by Layer adjust of Vortex Parameter b
            disp('Preliminary check complete - running layers ')

            for i = 1:obj.z_bf
                fprintf('\tComputing Layer %i \n',i);
                obj.dP_tspre(i) = 0;

                while obj.dP_tspre(i) > obj.dP_ts*1.01  || obj.dP_tspre(i) < obj.dP_ts*0.99

                    obj = volumetricchecktype1_iterate(obj,i);
                    obj.Vel_c_u2(i) = (obj.Vortex_a.*obj.r_bsi(i) + obj.Vortex_bsi(i))./obj.r_bsi(i);
                    obj.dP_ttd = obj.omega.*obj.r_bsi.*obj.Vel_c_u2.*obj.eta_h.*obj.rho;
                    obj = bladecorrectiontype1(obj);
                    obj = velocitytriangletype1(obj);
                    obj.dP_tspre(i) = obj.dP_ttd_cor(i).*obj.eta_h - 0.5.*obj.rho.*(obj.Vel_c_m2(i).^2 + obj.Vel_c_u2(i).^2);

                    if obj.dP_tspre(i) > obj.dP_ts
                        obj.Vortex_bsi(i) = obj.Vortex_bsi(i) - 0.01;
                    elseif obj.dP_tspre(i) < obj.dP_ts
                        obj.Vortex_bsi(i) = obj.Vortex_bsi(i) + 0.01;
                    end
                end
            ...
            %% Re-Run the code now for each layer
